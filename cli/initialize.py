...
from face2face.optimize.camera import estimateCamMat, splitCamMat
import face2face.optimize.image as opt
from face2face.utils.mesh import generateFace, generateTexture, getImgsColors, writePly
...
def main():
    ...
    print(f'File number: {len(keyframes)}')
    ...
    for i, frame in enumerate(keyframes):
        ...
        print(f'{m.numId} {m.numExp} {len(param)}')

        # pdb.set_trace()

        # # Init of R
        # param[m.numId + m.numExp:][:3] = [-1, -1.7, -0.2]       
        # # Init of T
        # param[m.numId + m.numExp:][3: 6] = [0.0, -80, 0]
        # print(param)
...
if __name__ == "__main__":
    ...
    # Command line:
    # c:\Users\koopc\AppData\Local\pypoetry\Cache\virtualenvs\report-maker-yRqx9TpN-py3.12\Scripts\python.exe .\cli\initialize.py --input_dir "..\identity_raw" --output_dir "..\identity_f2f"    
